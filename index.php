...
<div class="sidenav">
 ...
 <a href="addstudent.php" class="one" >Add Student</a>
 <a href="delete.php" class="one" >Remove a Student</a>
        ...
        <table width="180px" align="left" style="">
          ...
          <table width="400" border="2" align="left" bordercolor="black" bgcolor="white" style="margin-left:20px;">
            ...
            <tr bgcolor="black">
              ...
              <td width="110"><p style="color:#ffffff">Attendance</p></td>
            </tr>
            <?php
				include "z_db.php";
				extract($_POST);
            ...
            <tr>
              <td colspan="3"><div align="center">
               <br> <input type="submit" value="Submit" name="btnsubmit"/>&nbsp;&nbsp; <a href ="printreport.php" >report</a>
               <br> &nbsp;&nbsp;</div></td>
            </tr>
          </table>
          </form>
